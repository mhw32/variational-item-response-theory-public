...
from src.models_ import VIRTU_1PL_pytorch, VIRTU_2PL_pytorch, VIRTU_3PL_pytorch
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default='1pl_simulation',
                        choices=[
                            ...
                            '2pl_nonlinear',
                            '3pl_nonlinear',
                            'gradescope_course104450',
                            'gradescope_course99332',
                            'gradescope_course104885',
                            'gradescope_course105151',
                            'gradescope_course104394',
                            'gradescope_course104381',
                            'gradescope_course104253',
                            'gradescope_course94342',
                            'gradescope_course104417',
                            'gradescope_course102576',
                            'children_language',
                            'duolingo_language',
                            'wordbank_language',
                            'pisa2015_science',
    ...
    out_file = 'virtu_pytorch_{}_{}_{}_{}_{}person_{}item_{}maxperson_{}maxitem_{}maskperc_{}ability_{}_{}_seed{}'.format(
        args.irt_model, 
        args.dataset,
        args.response_dist,
    ...
    if args.irt_model == '1pl':
        model_class = VIRTU_1PL_pytorch
    elif args.irt_model == '2pl':
        model_class = VIRTU_2PL_pytorch
    elif args.irt_model == '3pl':
        model_class = VIRTU_3PL_pytorch
    else:
