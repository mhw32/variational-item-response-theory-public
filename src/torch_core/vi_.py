...
from src.models_ import VI_1PL_pytorch, VI_2PL_pytorch, VI_3PL_pytorch
...
if __name__ == "__main__":
    ...
    out_file = 'vi_pytorch_{}_{}_{}person_{}item_{}maskperc_{}ability'.format(
        args.irt_model,
        args.dataset,
        args.num_person, 
        args.num_item,
    ...
    if args.irt_model == '1pl':
        model_class = VI_1PL_pytorch
    elif args.irt_model == '2pl':
        model_class = VI_2PL_pytorch
    elif args.irt_model == '3pl':
        model_class = VI_3PL_pytorch
    else:
